...
class CampaignManager:
    ...
    def __repr__(self) -> str:
        return (
            f"CampaignManager("f"{len(self.campaigns)} campaigns, "
            f"total_spend=${self.total_spend():.2f})"
        )
...
# Edge case 2: all campaigns have zero conversions
